package com.example.austin.hackhealth;
...
import controller.StepCounterController;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("hackhealth","Lets get started");
...
//        StepController stepController = new StepController(achievement);
        //stepController.updateView();
...
//        });
        ...
        StepCounterController s = new StepCounterController(mStepDetectorSensor,stepCount);
        mSensorManager.registerListener(s,mStepDetectorSensor,1);
    }
